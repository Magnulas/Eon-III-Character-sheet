...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.importCharacterFromLocalStorage = function () {
        ...
        if (jsonData) {
            ...
            this.filename = this.character.name;
        }
    };
    ...
    AppComponent.prototype.newCharacter = function () {
        if (confirm("Är du säker på att du vill skapa en ny karaktär?.")) {
            this.character = this.functionWrapper.newCharacter();
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__directives_contenteditable_model_directive__ = __webpack_require__("./src/app/directives/contenteditable-model.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__directives_autosize_directive__ = __webpack_require__("./src/app/directives/autosize.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31_ng2_tooltip_directive__ = __webpack_require__("./node_modules/ng2-tooltip-directive/ng2-tooltip-directive.umd.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31_ng2_tooltip_directive___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_31_ng2_tooltip_directive__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pipes_json_circular_pipe__ = __webpack_require__("./src/app/pipes/json-circular.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pipes_array_constructor_pipe__ = __webpack_require__("./src/app/pipes/array-constructor.pipe.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
//import { FloorPipe, CeilPipe } from 'angular-pipes'
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_26__directives_aligned_directive__["a" /* AlignedDirective */], __WEBPACK_IMPORTED_MODULE_27__directives_focus_inputs_directive__["a" /* FocusInputsDirective */], __WEBPACK_IMPORTED_MODULE_30__directives_autosize_directive__["a" /* Autosize */], __WEBPACK_IMPORTED_MODULE_28__directives_localization_directive__["a" /* LocalizationDirective */], __WEBPACK_IMPORTED_MODULE_29__directives_contenteditable_model_directive__["a" /* ContenteditableModel */],
                __WEBPACK_IMPORTED_MODULE_32__pipes_json_circular_pipe__["a" /* JsonCircularPipe */], __WEBPACK_IMPORTED_MODULE_33__pipes_array_constructor_pipe__["a" /* ArrayConstructor */] //, FloorPipe, CeilPipe
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_31_ng2_tooltip_directive__["TooltipModule"]
            ],
            providers: [],
...
var CharacterSheetComponent = /** @class */ (function () {
    function CharacterSheetComponent(_el, _re) {
        ...
        this.showAttributeModifiers = false;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ContenteditableModel; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ContenteditableModel = /** @class */ (function () {
    ...
    ContenteditableModel.prototype.ngOnChanges = function (changes) {
        //console.log(changes)
        //console.log(this.lastViewModel)
        //if (isPropertyUpdated(changes, this.lastViewModel)) {
        if (changes.model.firstChange || changes.model.currentValue !== this.lastViewModel.currentValue) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('contenteditableModel'),
        __metadata("design:type", Object)
    ], ContenteditableModel.prototype, "model", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])('contenteditableModelChange'),
        __metadata("design:type", Object)
...
module.exports = "<div class=\"form-input\">\n    <label [contentEditable]=\"labelEditable\" [(contenteditableModel)]=\"label\" spellcheck=\"false\"></label>\n    <!--<label *ngIf=\"!labelEditable\">{{label}}</label>\n    <input *ngIf=\"labelEditable\" [(value)]=\"label\" type=\"text\"/>-->\n    <input #field [type]=\"type\" [(readonly)]=\"readonly\"\n        (change)=\"value = field.value\" [value]=\"value\" step=\"any\"\n        [tooltip]=\"value\" placement=\"top\" show-delay=\"150\" />\n</div>"
    ...
    Object.defineProperty(FormInputComponent.prototype, "labelEditable", {
        ...
        set: function (value) {
            if (typeof (value) === "string") {
                this._labelEditable = value === "true";
            }
            else {
                this._labelEditable = value === true;
            }
...
var CharacterAttribute = /** @class */ (function () {
    function CharacterAttribute() {
        this.name = null;
        this._valueModifier = Number.NaN;
        this._value = Number.NaN;
    }
    Object.defineProperty(CharacterAttribute.prototype, "value", {
        get: function () {
            if (this.valueBase === Number.NaN) {
                return this.valueBase;
            }
            var val = this.valueBase + this.asValidNumber(this.valueModifier);
            return val;
        },
        set: function (value) {
            value = Number(value);
            this.valueBase = value !== Number.NaN ? Math.floor(value - this.asValidNumber(this.valueModifier)) : value;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CharacterAttribute.prototype, "valueModifier", {
        get: function () {
            return Number(this._valueModifier);
        },
        set: function (value) {
            value = Number(value);
            this._valueModifier = value !== Number.NaN ? Math.floor(value) : value;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CharacterAttribute.prototype, "valueBase", {
        get: function () {
            return Number(this._value);
        },
        set: function (value) {
            value = Number(value);
            this._value = value !== Number.NaN ? Math.floor(value) : value;
        },
        enumerable: true,
        configurable: true
    });
    CharacterAttribute.prototype.asValidNumber = function (value) {
        if (!isFinite(value)) {
            return 0;
        }
        return value;
    ...
    __decorate([
        __WEBPACK_IMPORTED_MODULE_0_serializr__["f" /* serializable */],
        __metadata("design:type", Object)
    ], CharacterAttribute.prototype, "_valueModifier", void 0);
    __decorate([
        __WEBPACK_IMPORTED_MODULE_0_serializr__["f" /* serializable */],
        __metadata("design:type", Object)
...
var CharacterInferedAttribute = /** @class */ (function () {
    function CharacterInferedAttribute(baseValues, useBaseValue) {
        if (useBaseValue === void 0) { useBaseValue = false; }
        ...
        this._useBaseValue = useBaseValue;
    }
    ...
    Object.defineProperty(CharacterInferedAttribute.prototype, "useBaseValue", {
        get: function () {
            return this._useBaseValue;
        },
        set: function (value) {
            this._useBaseValue = value;
        },
        enumerable: true,
        configurable: true
    });
            ...
            if (self.baseValues) {
                this._variableNames.forEach(function (key) {
                    if (self.baseValues[key] && self.baseValues[key].value !== null && typeof self.baseValues[key].value !== 'undefined')
                        values[key] = self.useBaseValue ? self.baseValues[key].valueBase : self.baseValues[key].value;
                });
            }
    ...
    __decorate([
        __WEBPACK_IMPORTED_MODULE_0_serializr__["f" /* serializable */],
        __metadata("design:type", Boolean)
    ], CharacterInferedAttribute.prototype, "_useBaseValue", void 0);
...
var CharacterObject = /** @class */ (function () {
    function CharacterObject() {
        ...
        this._focus = CharacterObject.maxWellBeing;
        this._wellBeing = CharacterObject.maxWellBeing;
        var self = this;
        ...
        this.inferedBaseSkills = {
            constitution: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            dexterity: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            intelligence: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            education: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            charismaIntelligence: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            dexterityIntelligence: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            sightIntelligence: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true),
            nativeLanguage: new __WEBPACK_IMPORTED_MODULE_2__character_attribute__["c" /* CharacterInferedAttribute */](this.attributes, true)
        };
    ...
    Object.defineProperty(CharacterObject.prototype, "focus", {
        get: function () {
            return this._focus;
        },
        set: function (value) {
            this._focus = Math.min(value, this._wellBeing);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CharacterObject.prototype, "wellBeing", {
        get: function () {
            return this._wellBeing;
        },
        set: function (value) {
            this._wellBeing = Math.min(value, CharacterObject.maxWellBeing);
            this.focus = this.focus; //Set the focs again since the max may have changed
        },
        enumerable: true,
        configurable: true
    });
...
Object(__WEBPACK_IMPORTED_MODULE_12_serializr__["a" /* createModelSchema */])(CharacterObject, {
    ...
    _focus: Object(__WEBPACK_IMPORTED_MODULE_12_serializr__["e" /* primitive */])(),
    _wellBeing: Object(__WEBPACK_IMPORTED_MODULE_12_serializr__["e" /* primitive */])(),
